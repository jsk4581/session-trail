// session-trail event store: append-only JSONL under <project>/.session-trail/
...
export const DATA_DIR_NAME = ".session-trail";
 ...
 * for an existing .session-trail/ > cwd itself.
 */
